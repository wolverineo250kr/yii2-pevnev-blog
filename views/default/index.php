...
$grid_columns                  = [
    ...
    [
        'attribute' => 'image',
        'contentOptions' => ['width' => '150', 'class' => 'image text-center',],
        'value' => function($model) {
            return '<a target="_blank" href="'.$model->src.'" data-fancybox="gallery"><img height="50" src="'.$model->src.'"></a>';
        },
        'format' => 'raw',
    ],
        [
        'attribute' => 'views',
        'contentOptions' => ['width' => '150', 'class' => ' text-center']
    ],
            [
        'label' => '',
        'value' => function ($model) {
    ...
    [
        'attribute' => 'name',
        'contentOptions' => ['width' => '100', 'class' => 'name'],
    ],

    [
        'attribute' => 'is_active',
        'contentOptions' => ['width' => '40', 'class' => 'is_active'],
    ...
    [
        ...
        'contentOptions' => ['width' => '100', 'class' => 'text_announcement'],
    ],
        [
        'attribute' => 'url',
        'contentOptions' => ['class' => 'url', 'width' => '100', ],
    ],
    [
        'attribute' => 'timestamp',
        'contentOptions' => ['class' => 'timestamp', 'width' => '100'], 
    ...
    [
        ...
        'contentOptions' => ['class' => 'timestamp_start', 'width' => '100'],   
